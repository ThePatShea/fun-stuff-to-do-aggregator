<?php
	...
	$req_perms = "email,user_education_history,friends_education_history,user_events,friends_events,rsvp_event,friends_groups,user_likes,friends_likes,user_groups,publish_actions";
	
	# Defining the App ID and App Secret
	$app_id				=	"219781404699497";
	$app_secret 		=	"11efd0dea9edbb5461a0b74c6227ff42";
	$app_access_token	=	"219781404699497|mujR6v7yz3jD1_jR_pzr8DRKyjw";
	...
	# Defining the $login_url and $session variables
	...
	class Facebook
	{
	  ...
	  public static $CURL_OPTS = array(
	    CURLOPT_CONNECTTIMEOUT => 1000000,
